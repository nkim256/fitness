...
private:
    ...
    void saveUsers() const
    {
        ...
        { // itterate thru vector of users and send to output file to save
...
private:
    ...
    void saveLog() const
    {
        ...
        for (const WorkoutLog &workout : logs)
        { // itterate thru vector of users and send to output file to save
...
public:
    ...
    // addWorkout function
    void addWorkout()
    { // NEXT NEED TO BE ABLE TO ADD DIFFERENT REPS FOR EACH SET
    ...
    void printWorkout()
    {
        ...
        for (WorkoutLog &workout : logs)
        {
            if (workout.userName == userName)
            {
                ...
                cout << workout.date << " " << workout.exercise << " sets:" << workout.sets << " reps: " << workout.reps << " weight: " << workout.weight << endl;
                userFound = true;
                break;
            }
        }
...
int main()
{
    ...
    do
    { // loop until user no longer wants to update or check stats
        cout << "\n\n-----------------" << endl;
        cout << "      MENU" << endl;
        cout << "-----------------" << endl;
